                        ...
                        <div className="flex flex-row items-center justify-center gap-2 flex-wrap">
                            ...
                            <div className="flex flex-wrap justify-center items-center gap-2">
                                ...
                                <button
                                    ...
                                    className="flex items-center gap-1 bg-blue-600 hover:bg-blue-700 text-white px-3 py-1.5 rounded text-xs font-medium transition-colors duration-200 cursor-pointer"
                                ...
                                <button
                                    ...
                                    className="flex items-center gap-1 bg-black hover:bg-gray-800 text-white px-3 py-1.5 rounded text-xs font-medium transition-colors duration-200 cursor-pointer"
                                ...
                                <button
                                    ...
                                    className="flex items-center gap-1 bg-blue-700 hover:bg-blue-800 text-white px-3 py-1.5 rounded text-xs font-medium transition-colors duration-200 cursor-pointer"
                                ...
                                {typeof navigator !== 'undefined' && typeof navigator.share === 'function' && (
                                    <button
                                        onClick={shareNative}
                                        className="flex items-center gap-1 bg-gray-600 hover:bg-gray-700 text-white px-3 py-1.5 rounded text-xs font-medium transition-colors duration-200 cursor-pointer"
