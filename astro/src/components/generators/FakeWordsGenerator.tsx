...
interface FakeWordsGeneratorProps {
    basePath?: string;
}

export default function FakeWordsGenerator({ basePath = '' }: FakeWordsGeneratorProps) {
    const {
        words,
        loading,
        showLoading,
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="mt-8 bg-white rounded-lg shadow-lg p-8">
                    <div className="grid grid-cols-1 md:grid-cols-[1fr_355px] gap-8">
                        ...
                        <div>
                            <OtherGenerators currentPage="/fake-words" basePath={basePath} />
                        </div>
                    </div>
                </div>
            </div>
