...
interface AdjectiveGeneratorProps {
    basePath?: string;
}

export default function AdjectiveGenerator({ basePath = '' }: AdjectiveGeneratorProps) {
    const {
        words,
        loading,
        showLoading,
        ...
        autoGenerate: true,
        favoritesKey: 'adjectiveFavorites',
                ...
                <div className="mt-8 bg-white rounded-lg shadow-lg p-8">
                    <div className="grid grid-cols-1 md:grid-cols-[1fr_355px] gap-8">
                        <ArticleContent>
                            ...
                            <p>Did you know that there are actually three types of adjectives in the English language? Can you guess what they are? The following are the three different types of adjectives that are included in the calculator:</p>
                        ...
                        <div>
                            <OtherGenerators currentPage="/adjective" basePath={basePath} />
                        </div>
                    </div>
                </div>
            </div>
