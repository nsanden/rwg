...
export default function WordGenerator({ basePath = '' }: WordGeneratorProps) {
    const {
        words,
        loading,
        showLoading,
    ...
    const formState = useGeneratorForm({
        wordType: wordType,
        onGenerate: (params) => {
            const extraParams = wordType === 'non-english'
    ...
    const wordTypeOptions = (
        <div className="mb-4 space-y-3">
            <div>
                <label htmlFor="word-type" className="font-medium text-gray-700 mr-3">
                    Word Type:
                </label>
                <select
                    id="word-type"
                ...
                >
                    ...
                    <option value="non-english">Foreign Language</option>
                </select>
            </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    ...
                    <div className="w-full">
                        <ItemsDisplay
                            ...
                            onReset={() => {
                                ...
                                setLanguage('es');
                                formState.resetOptions();
                                // Generate with default word type
                                generateWords({ type: 'all' });
                            }}
                        />
                    </div>
                </div>
                ...
                <div className="mt-8 bg-white rounded-lg shadow-lg p-8">
                    <div className="grid grid-cols-1 md:grid-cols-[1fr_350px] gap-8">
                        ...
                        <div>
                            <OtherGenerators currentPage="/" basePath={basePath} />
                        </div>
                    </div>
                </div>
            </div>
