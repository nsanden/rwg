...
export default function ArticleContent() {
    return (
        <div className="space-y-6 text-gray-700 leading-relaxed">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mt-8 mb-4">Games</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold text-gray-800 mt-8 mb-4">Creative Writing</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold text-gray-800 mt-8 mb-4">Spelling and Vocabulary</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold text-gray-800 mt-8 mb-4">Name Inspiration</h3>
            <p>
            ...
            <div className="mt-12">
                ...
                <div className="space-y-6">
                    <div>
                        <h4 className="text-lg font-semibold text-gray-800 mb-2">What is the most common word?</h4>
                        <p>
                    ...
                    <div>
                        <h4 className="text-lg font-semibold text-gray-800 mb-2">What is a random word?</h4>
                        <p>
                    ...
                    <div>
                        <h4 className="text-lg font-semibold text-gray-800 mb-2">What is the most random word?</h4>
                        <p>
                    ...
                    <div>
                        <h4 className="text-lg font-semibold text-gray-800 mb-2">Is every word in English in your random word generator?</h4>
                        <p>
